...
public class Schedule extends javax.swing.JFrame {
	...
	Date date = new Date();
        this.jLabel1.setText(""+dateFormat.format(date));
        int i=1;
        Calendar calendar = Calendar.getInstance();
        calendar.add(Calendar.DAY_OF_YEAR, i);
        date=calendar.getTime();
        this.jLabel2.setText(""+dateFormat.format(date));
        calendar.add(Calendar.DAY_OF_YEAR, i);
        date=calendar.getTime();
        this.jLabel4.setText(""+dateFormat.format(date));
        calendar.add(Calendar.DAY_OF_YEAR, i);
        date=calendar.getTime();
        this.jLabel5.setText(""+dateFormat.format(date));
        calendar.add(Calendar.DAY_OF_YEAR, i);
        date=calendar.getTime();
        this.jLabel3.setText(""+dateFormat.format(date));
